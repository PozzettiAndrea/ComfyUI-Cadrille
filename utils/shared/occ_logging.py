...
"""
Logging infrastructure for Cadrille operations.
"""
...
logger = logging.getLogger("Cadrille")
...
def setup_logging(level: int = logging.INFO, log_file: str = None):
    ...
    if not logger.handlers:
        ...
        console.setFormatter(logging.Formatter("[%(asctime)s] [Cadrille] %(message)s", datefmt="%H:%M:%S"))
